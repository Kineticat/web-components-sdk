...
export class BridgeBase extends LitElement {
  ...
  constructor(inDebug = false, inLogging = false) {
    ...
    if (inDebug) {
      this.bDebug = true;
    } // If you change the assignment of this.bDebug for your local development preference, please don't commit that change
    if (inLogging) {
      this.bLogging = true;
    } // If you change the assignment of this.bLogging for your local development preference, please don't commit that change
  ...
  onStateChange() {
    if (this.bLogging) {
      console.log(`${this.baseComponentName}: onStateChange`);
    }
  }
  ...
  prepareForRender(inDisplayOnlyFA: boolean = false) {
    ...
    if (this.bLogging) {
      console.log(`${this.theComponentName}: prepare for render`);
    }
